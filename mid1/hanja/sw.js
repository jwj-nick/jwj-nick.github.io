...
const CACHE = "hanja-v2-cache-v18"; // 배포 라운드마다 이 버전을 올려 즉시 갱신을 강제한다(v3 런북 규약).
const SHELL = ["./", "./index.html", "./style.css", "./app.js", "./config.js", "./site.webmanifest", "./icon.svg", "./data/manifest.json", "./data/words.json", "./data/idioms.json", "./data/readings.json"];
